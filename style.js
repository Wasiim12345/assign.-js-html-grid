...
let outputClothingCards = '';
let outputAccessoriesCards = '';

for (i = 0; i < productList.length; i++) {
  const product = productList[i];
  console.log(i, productList[i].isAccessory);

  if (product.isAccessory === true) {

    outputAccessoriesCards += `<div class="card" id="${product.id}">
          <div class="img">
    ...
    outputClothingCards += `<div class="card" id="${product.id}">
          <div class="img">
              <img src=${product.preview}>
          </div>
          <div class="details">
  ...
  clothingCards.innerHTML = outputClothingCards;
  accessoriesCards.innerHTML = outputAccessoriesCards;
